...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Directory where you store static files
]
...
JAZZMIN_SETTINGS = {
    ...
    "icons": {
        ...
        "Requests.Requester": "fas fa-users",
        "Requests.Buyer": "fas fa-users",
        "Requests.Request": "fas fa-file",
...
CSRF_TRUSTED_ORIGINS = ['https://your-domain.com', 'https://your-render-app-url.com']
